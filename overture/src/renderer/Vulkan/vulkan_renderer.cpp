...
void VulkanRenderer::init() {
	...
	createDescriptorPoolSets();
	createCommandBuffers();
	createSyncObjects();

	WindowEventBus::bind(FRAMEBUFFER_RESIZE, onResize);
}
...
void VulkanRenderer::createSwapChain() {
	//TODO: fix minor bug: swap chain extent is bigger than allowed 
...
//TODO: just change it after we have triangle to accomodate all types of shit
void VulkanRenderer::createGraphicsPipeline() {
	auto vertShaderCode = readFile("../overture/res/vert.spv");
	auto fragShaderCode = readFile("../overture/res/frag.spv");
...
b8 VulkanRenderer::hasStencilComponent(VkFormat format) {
...
void VulkanRenderer::createTextureImage() {
    ...
    stbi_uc* pixels = stbi_load("../overture/res/cover.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
void VulkanRenderer::createDescriptorPoolSets() {
